...
import deprecate_systems from '@proposals/description/deprecate_systems';

export const ProposalsConfig: TemplatedProposalsConfigMap = {
  deprecate_systems: {
    deploy: true, // deploy flag for whether to run deploy action during e2e tests or use mainnet state
    totalValue: 0, // amount of ETH to send to DAO execution
    proposal: deprecate_systems, // full proposal file, imported from '@proposals/description/fip_xx.ts'
    proposalId: '',
