export default {
  ...
  curve3Metapool: { allocPoint: 1000, unlocked: false }, // Curve 3crv-FEI metapool LP
  ...
  fei3CrvStakingtokenWrapper: { allocPoint: 250, unlocked: false }, // FeiRari: 3crv-FEI metapool LP
