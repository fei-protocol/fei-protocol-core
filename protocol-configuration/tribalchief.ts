...
const config: TribalChiefConfig = {
  ...
  stakingTokenWrapperRari: { allocPoint: 1, unlocked: false }, // FeiRari: TRIBE
  ...
  stakingTokenWrapperBribeD3pool: { allocPoint: 0, unlocked: false }, // Votium bribes: d3pool
  d3StakingTokenWrapper: { allocPoint: 0, unlocked: false }, // FeiRari: d3pool LP
  fei3CrvStakingtokenWrapper: { allocPoint: 0, unlocked: false }, // FeiRari: 3crv-FEI metapool LP
  feiDaiStakingTokenWrapper: { allocPoint: 0, unlocked: false }, // FeiRari: G-UNI DAI/FEI 0.05% fee tier
  feiUsdcStakingTokenWrapper: { allocPoint: 0, unlocked: false }, // FeiRari: G-UNI USDC/FEI 0.01% fee tier
  stakingTokenWrapperBribe3Crvpool: { allocPoint: 0, unlocked: false } // Votium bribes: 3crv-FEI metapool
};
