const collateralizationAddresses = {
  ...
  lusd: ['liquityFusePoolLusdPCVDeposit', 'rariPool7LusdPCVDeposit', 'bammDeposit', 'lusdPSM', 'lusdToDaiLensLusd'],
  dai: ['compoundDaiPCVDepositWrapper', 'daiPSM', 'lusdToDaiLensDai'],
