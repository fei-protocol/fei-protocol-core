...
async function run(addresses, oldContracts, contracts, logging = false) {
  ...
  logging ? console.log(' > Dripper ETH balance :', (await web3.eth.getBalance(ethPCVDripper.address)) / 1e18) : undefined;
  logging ? console.log(' > EthLidoPCVDeposit ETH balance :', (await web3.eth.getBalance(ethLidoPCVDeposit.address)) / 1e18) : undefined;
  logging ? console.log(' > EthLidoPCVDeposit stETH balance :', (await steth.balanceOf(ethLidoPCVDeposit.address)) / 1e18) : undefined;
