...
import { RunUpgradeFunc, SetupUpgradeFunc, TeardownUpgradeFunc, ValidateUpgradeFunc } from "../../test/integration/setup/types";
...
const teardown: TeardownUpgradeFunc = async(addresses, oldContracts, contracts, logging) => {
    ...
    await tribalChiefOptimisticTimelock.connect(await ethers.getSigner(tribalChiefOptimisticMultisig)).executeTransaction(
