  ...
  commands: [
    {
      ...
      description: 'Grant Fei dev, Tom, POD_METADATA_REGISTER_ROLE to register proposal metadata'
    },
    {
      target: 'core',
      values: '0',
      ...
      description: 'Grant Fei dev, Caleb, POD_METADATA_REGISTER_ROLE to register proposal metadata'
    },
    {
      target: 'core',
      values: '0',
    ...
    },
    {
      ...
      description: 'Grant Fei dev, Joey, POD_METADATA_REGISTER_ROLE to register proposal metadata'
    }
  ],
  description: `
  Grant Fei engineers the POD_METADATA_REGISTER_ROLE so they are able to register pod proposal metadata
  `
};
