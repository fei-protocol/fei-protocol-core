...
const fip_60: ProposalDescription = {
  ...
  commands: [
    // TODO add TC Sync actions before and after
    {
    ...
    },
    {
      ...
      arguments: [
        false,
        '',
        '600000000000000000'
      ],
    ...
    },
    {
      ...
      arguments: ['250', '{d3StakingTokenWrapper}', '0x0000000000000000000000000000000000000000', [[0, 10000]]],
    ...
    },
    {
      ...
      description: 'Add gelato to TribalChief'
    },
    {
    ...
    {
      target: 'gelatoFEIUSDCStakingTokenWrapper',
      values: '0',
      method: 'init(uint256)',
      arguments: [14],
      description: 'Init Gelato STW'
    },
    {
    ...
    {
      target: 'gelatoAutoRewardsDistributor',
      values: '0',
      method: 'init()',
      arguments: [],
      description: 'Init gelato AutoRewardsDistributor'
    },
    {
    ...
    },
    {
      ...
      description: 'Grant ARD role to gelato AutoRewardsDistributor'
    }
  ],
  description: ``
};
