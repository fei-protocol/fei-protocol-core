...
const fip_78b: ProposalDescription = {
  title: 'FIP-78b: Restore newTimelock to FeiDAO',
  commands: [
    {
      target: 'proxyAdmin',
      values: '0',
  ...
  description: `
  This FIP is the second stage in FIP 78, which changes the owner of the ProxyAdmin contract from the old timelock 
  to the new FEI DAO timelock. This is being done to allow an incentive contract to be upgraded. 

  Specifically, this FIP 78b transfers ownership of the ProxyAdmin from the old timelock to the new timelock. 
