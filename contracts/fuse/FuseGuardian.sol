...
contract FuseGuardian is CoreRef {
    ...
    constructor(address _core, Unitroller _comptroller) CoreRef(_core) {
    ...
    function _setMintPausedByUnderlying(address underlying, bool state)
        external
        isGovernorOrGuardianOrAdmin
        returns (bool)
    {
    ...
    function _setBorrowPausedByUnderlying(address underlying, bool state)
        external
        isGovernorOrGuardianOrAdmin
        returns (bool)
    {
