...
import "./IAngleUniswapPCVDeposit.sol";
...
contract AngleUniswapPCVDeposit is IAngleUniswapPCVDeposit, PCVDeposit, UniRef {
    ...
    constructor(
        ...
        require(poolManager.token() == address(fei()), "AngleUniswapPCVDeposit: invalid poolManager");
        require(_stableMaster.agToken() == token, "AngleUniswapPCVDeposit: invalid stableMaster");
        require(stakingRewards.stakingToken() == _pair, "AngleUniswapPCVDeposit: invalid stakingRewards");
        ...
        whenNotPaused
    {
        ...
        require(
            ...
            "AngleUniswapPCVDeposit: Insufficient underlying"
        );
    ...
    /// @notice mint agToken with the FEI balance of this contract
        ...
        onlyGovernorOrAdmin
    {
        require(
            ...
            "AngleUniswapPCVDeposit: basis points from peg too high"
        );
    ...
    function _addLiquidity(uint256 tokenAmount, uint256 feiAmount) internal {
        ...
        (, , uint256 liquidityMinted) = router.addLiquidity(
            address(fei()),
            token,
            feiAmount,
            tokenAmount,
        ...
        stakingRewards.stake(liquidityMinted);
    }
