...
contract NamedStaticPCVDepositWrapper is IPCVDepositBalances, CoreRef {
    ...
    function _removeDeposit(uint256 index) internal {
        require(index < pcvDeposits.length, "NamedStaticPCVDepositWrapper: index out of bounds, cannot remove");
    ...
    function _editDeposit(
        ...
        require(index < pcvDeposits.length, "NamedStaticPCVDepositWrapper: index out of bounds, cannot edit");
