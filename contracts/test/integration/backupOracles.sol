...
contract UniswapV3OracleIntegrationTest is DSTest, StdLib {
    ...
    function setUp() public {
        ...
        UniswapV3OracleWrapper.OracleConfig
            memory daiUsdOracleConfig = UniswapV3OracleWrapper.OracleConfig({
        ...
        UniswapV3OracleWrapper.OracleConfig
            memory usdcEthOracleConfig = UniswapV3OracleWrapper.OracleConfig({
                twapPeriod: twapPeriod,
        ...
        UniswapV3OracleWrapper.OracleConfig
            memory wbtcUsdcOracleConfig = UniswapV3OracleWrapper.OracleConfig({
                twapPeriod: twapPeriod,
        ...
        UniswapV3OracleWrapper.OracleConfig
            memory usdtAvinocOracleConfig = UniswapV3OracleWrapper
                .OracleConfig({
                    twapPeriod: twapPeriod,
        ...
        UniswapV3OracleWrapper.OracleConfig
            memory usdcFeiOracleConfig = UniswapV3OracleWrapper.OracleConfig({
                twapPeriod: twapPeriod,
    ...
    function testAddPoolSupport() public {
        ...
        UniswapV3OracleWrapper.OracleConfig
            memory highTwapPeriodConfig = UniswapV3OracleWrapper.OracleConfig({
        ...
        uint16 expectedCardinalityForMaxTwapPeriod = uint16(
            highTwapPeriod / meanBlockTime
        ) + uint16(10);
        assertEq(
            observationCardinalityNext,
            expectedCardinalityForMaxTwapPeriod
        );
    }
