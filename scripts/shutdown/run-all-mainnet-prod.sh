...
npx ts-node scripts/shutdown/createMerkleTrees.ts ./proposals/data/merkle_redemption/prod/balances.json ./proposals/data/merkle_redemption/prod/roots.json true ./proposals/data/merkle_redemption/prod/testAccounts.json
