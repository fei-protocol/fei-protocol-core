...
npx ts-node scripts/shutdown/createMerkleTrees.ts ./proposals/data/merkle_redemption/sample/balances.json ./proposals/data/merkle_redemption/sample/roots.json true ./proposals/data/merkle_redemption/sample/testAccounts.json
