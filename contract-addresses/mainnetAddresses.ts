import { MainnetAddresses, AddressEnum } from '@custom-types/types';
...
const MainnetAddresses: MainnetAddresses = {
  ...
  alusd: { artifactName: 'IERC20', address: '0xBC6DA0FE9aD5f3b0d58160288917AA56653660E9', type: AddressEnum.TBD_ },
  pcvGuardian: {
  ...
  aave: { artifactName: 'IERC20', address: '0x7Fc66500c84A76Ad7e9c93437bFc5Ac33E2DDaE9', type: AddressEnum.TBD_ },
  aaveEthPCVDeposit: {
  ...
  aFei: { artifactName: 'IERC20', address: '0x683923dB55Fead99A79Fa01A27EeC3cB19679cC3', type: AddressEnum.TBD_ },
  aFeiStableDebt: {
    artifactName: 'IERC20',
  ...
  aRai: { artifactName: 'IERC20', address: '0xc9BC48c72154ef3e5425641a3c747242112a46AF', type: AddressEnum.TBD_ },
  aWETH: { artifactName: 'IERC20', address: '0x030bA81f1c18d280636F32af80b9AAd02Cf0854e', type: AddressEnum.TBD_ },
  balancerAdmin: {
    artifactName: 'unknown',
  ...
  bal: { artifactName: 'IERC20', address: '0xba100000625a3754423978a60c9317c58a424e3D', type: AddressEnum.TBD_ },
  bentoBox: {
  ...
  core: { artifactName: 'Core', address: '0x8d5ED43dCa8C2F7dFB20CF7b53CC7E593635d7b9', type: AddressEnum.TBD_ },
  coreV1: { artifactName: 'ICoreV1', address: '0x8d5ED43dCa8C2F7dFB20CF7b53CC7E593635d7b9', type: AddressEnum.TBD_ },
  creamFei: {
  ...
  crv: { artifactName: 'IERC20', address: '0xD533a949740bb3306d119CC777fa900bA034cd52', type: AddressEnum.TBD_ },
  cvx: { artifactName: 'IERC20', address: '0x4e3FBD56CD56c3e72c1403e103b45Db9da5B9D2B', type: AddressEnum.TBD_ },
  curve3crv: { artifactName: 'unknown', address: '0x6c3F90f043a72FA612cbac8115EE7e52BDe6E490', type: AddressEnum.TBD_ },
  curve3pool: {
    artifactName: 'unknown',
  ...
  dai: { artifactName: 'IERC20', address: '0x6B175474E89094C44Da98b954EedeAC495271d0F', type: AddressEnum.TBD_ },
  daiBondingCurve: {
  ...
  dpi: { artifactName: 'IERC20', address: '0x1494CA1F11D487c2bBe4543E90080AeBa4BA3C2b', type: AddressEnum.TBD_ },
  dpiBondingCurve: {
    artifactName: 'BondingCurve',
  ...
  fei: { artifactName: 'Fei', address: '0x956F47F50A910163D8BF957Cf5846D573E7f87CA', type: AddressEnum.TBD_ },
  feiDAO: { artifactName: 'FeiDAO', address: '0x0BEF27FEB58e857046d630B2c03dFb7bae567494', type: AddressEnum.TBD_ },
  feiDAOTimelock: {
  ...
  frax: { artifactName: 'IERC20', address: '0x853d955aCEf822Db058eb8505911ED77F175b99e', type: AddressEnum.TBD_ },
  genesisGroup: {
    artifactName: 'unknown',
  ...
  index: { artifactName: 'IERC20', address: '0x0954906da0Bf32d5479e25f46056d22f08464cab', type: AddressEnum.External_ },
  ...
  lusd: { artifactName: 'IERC20', address: '0x5f98805A4E8be255a32880FDeC7F6728C6568bA0', type: AddressEnum.External_ },
  kashiFeiDPI: {
  ...
  multisig: { artifactName: 'unknown', address: '0xB8f482539F2d3Ae2C9ea6076894df36D1f632775', type: AddressEnum.TBD_ },
  oldEthBondingCurve: {
    artifactName: 'EthBondingCurve',
  ...
  rai: { artifactName: 'IERC20', address: '0x03ab458634910AaD20eF5f1C8ee96F1D6ac54919', type: AddressEnum.External_ },
  raiBondingCurve: {
    artifactName: 'BondingCurve',
    address: '0x25d60212D47Dd8F6Ff0469367E4c6C98Cd3411A5',
    type: AddressEnum.Peg_
  },
  rariPool19Dpi: {
    artifactName: 'CErc20Delegator',
    address: '0xf06f65a6b7d2c401fcb8b3273d036d21fe2a5963',
  ...
  fAAVE: { artifactName: 'IERC20', address: '0x4da27a545c0c5b758a6ba100e3a049001de870f5', type: AddressEnum.TBD_ },
  stakingTokenWrapperRari: {
    artifactName: 'StakingTokenWrapper',
    address: '0xd81Be1B9A7895C996704A8DDa794BbA4454EeB90',
    type: AddressEnum.Rewards_
  },
  tWETH: { artifactName: 'IERC20', address: '0xD3D13a578a53685B4ac36A1Bab31912D2B2A2F36', type: AddressEnum.External_ },
  tToke: { artifactName: 'IERC20', address: '0xa760e26aA76747020171fCF8BdA108dFdE8Eb930', type: AddressEnum.External_ },
  toke: { artifactName: 'IERC20', address: '0x2e9d63788249371f1dfc918a52f8d799f4a38c94', type: AddressEnum.External_ },
  ...
  steth: { artifactName: 'IERC20', address: '0xae7ab96520DE3A18E5e111B5EaAb095312D7fE84', type: AddressEnum.External_ },
  sushiswapDpiFei: {
    artifactName: 'IUniswapV2Pair',
  ...
  tribe: { artifactName: 'Tribe', address: '0xc7283b66Eb1EB5FB86327f08e1B5816b0720212B', type: AddressEnum.Core_ },
  tribeOTCEscrow: {
    artifactName: 'OtcEscrow',
  ...
  weth: { artifactName: 'IWETH', address: '0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2', type: AddressEnum.External_ },
  wethERC20: {
    artifactName: 'IERC20',
