...
const MainnetAddresses: MainnetAddresses = {
  ...
  core: { artifactName: 'Core', address: '0x8d5ED43dCa8C2F7dFB20CF7b53CC7E593635d7b9', category: AddressCategory.Core },
  coreV1: {
  ...
  fei: { artifactName: 'Fei', address: '0x956F47F50A910163D8BF957Cf5846D573E7f87CA', category: AddressCategory.Core },
  feiDAO: {
    artifactName: 'FeiDAO',
  ...
  feiLusdLBPSwapper: {
    ...
    category: AddressCategory.PCV // TODO deprecate after FIP-50
  },
  feiLusdLBP: {
    artifactName: 'IWeightedPool',
  ...
  multisig: {
    ...
    category: AddressCategory.Deprecated // Deprecated to rename to guardian
  },
  guardian: {
    artifactName: 'unknown',
    address: '0xB8f482539F2d3Ae2C9ea6076894df36D1f632775',
  ...
  tribalChiefOptimisticMultisig: {
    ...
    category: AddressCategory.Deprecated // Deprecated to rename to optimistic multisig
  },
  optimisticMultisig: {
    artifactName: 'unknown',
    address: '0x35ED000468f397AA943009bD60cc6d2d9a7d32fF',
