## <span id="MockERC20"></span> `MockERC20`
...
### <span id="MockERC20-mint-address-uint256-"></span> `mint(address account, uint256 amount) → bool` (public)



### <span id="MockERC20-mockBurn-address-uint256-"></span> `mockBurn(address account, uint256 amount) → bool` (public)



### <span id="MockERC20-approveOverride-address-address-uint256-"></span> `approveOverride(address owner, address spender, uint256 amount)` (public)
