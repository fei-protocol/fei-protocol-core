## <span id="MockOZGovernorVoter"></span> `MockOZGovernorVoter`
...
- [`constructor(address core)`][MockOZGovernorVoter-constructor-address-]
...
### <span id="MockOZGovernorVoter-constructor-address-"></span> `constructor(address core)` (public)
