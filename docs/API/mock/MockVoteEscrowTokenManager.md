## <span id="MockVoteEscrowTokenManager"></span> `MockVoteEscrowTokenManager`
...
- [`constructor(address core, address liquidToken, address veToken, uint256 maxTime)`][MockVoteEscrowTokenManager-constructor-address-address-address-uint256-]
...
### <span id="MockVoteEscrowTokenManager-constructor-address-address-address-uint256-"></span> `constructor(address core, address liquidToken, address veToken, uint256 maxTime)` (public)
