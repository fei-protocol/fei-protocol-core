## <span id="MockWeth"></span> `MockWeth`



- [`deposit()`][MockWeth-deposit--]
- [`withdraw(uint256 amount)`][MockWeth-withdraw-uint256-]
...
### <span id="MockWeth-deposit--"></span> `deposit()` (external)



### <span id="MockWeth-withdraw-uint256-"></span> `withdraw(uint256 amount)` (external)
