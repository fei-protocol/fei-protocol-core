## <span id="BAMMDeposit"></span> `BAMMDeposit`
...
- [`constructor(address core)`][BAMMDeposit-constructor-address-]
- [`receive()`][BAMMDeposit-receive--]
- [`deposit()`][BAMMDeposit-deposit--]
- [`withdraw(address to, uint256 amount)`][BAMMDeposit-withdraw-address-uint256-]
- [`balance()`][BAMMDeposit-balance--]
- [`claimRewards()`][BAMMDeposit-claimRewards--]
...
### <span id="BAMMDeposit-constructor-address-"></span> `constructor(address core)` (public)



### <span id="BAMMDeposit-receive--"></span> `receive()` (external)



### <span id="BAMMDeposit-deposit--"></span> `deposit()` (external)



### <span id="BAMMDeposit-withdraw-address-uint256-"></span> `withdraw(address to, uint256 amount)` (external)



### <span id="BAMMDeposit-balance--"></span> `balance() → uint256` (public)



### <span id="BAMMDeposit-claimRewards--"></span> `claimRewards()` (public)
