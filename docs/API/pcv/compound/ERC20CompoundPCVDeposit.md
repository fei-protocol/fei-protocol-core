## <span id="ERC20CompoundPCVDeposit"></span> `ERC20CompoundPCVDeposit`
...
- [`constructor(address _core, address _cToken)`][ERC20CompoundPCVDeposit-constructor-address-address-]
- [`deposit()`][ERC20CompoundPCVDeposit-deposit--]
- [`_transferUnderlying(address to, uint256 amount)`][ERC20CompoundPCVDeposit-_transferUnderlying-address-uint256-]
- [`balanceReportedIn()`][ERC20CompoundPCVDeposit-balanceReportedIn--]
...
### <span id="ERC20CompoundPCVDeposit-constructor-address-address-"></span> `constructor(address _core, address _cToken)` (public)



### <span id="ERC20CompoundPCVDeposit-deposit--"></span> `deposit()` (external)



### <span id="ERC20CompoundPCVDeposit-_transferUnderlying-address-uint256-"></span> `_transferUnderlying(address to, uint256 amount)` (internal)



### <span id="ERC20CompoundPCVDeposit-balanceReportedIn--"></span> `balanceReportedIn() → address` (public)
