## <span id="CompoundPCVDepositBase"></span> `CompoundPCVDepositBase`
...
- [`constructor(address _core, address _cToken)`][CompoundPCVDepositBase-constructor-address-address-]
...
- [`_transferUnderlying(address to, uint256 amount)`][CompoundPCVDepositBase-_transferUnderlying-address-uint256-]
...
### <span id="CompoundPCVDepositBase-constructor-address-address-"></span> `constructor(address _core, address _cToken)` (internal)



### <span id="CompoundPCVDepositBase-withdraw-address-uint256-"></span> `withdraw(address to, uint256 amountUnderlying)` (external)



### <span id="CompoundPCVDepositBase-balance--"></span> `balance() → uint256` (public)

returns stale values from Compound if the market hasn't been updated

### <span id="CompoundPCVDepositBase-_transferUnderlying-address-uint256-"></span> `_transferUnderlying(address to, uint256 amount)` (internal)
